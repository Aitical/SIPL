...
class PromptIR_ProxyFusion(nn.Module):
    def __init__(self,
                 inp_channels=3,
                 out_channels=3,
                 dim=48,
        ...
        super(PromptIR_ProxyFusion, self).__init__()
    ...
    def forward(self, inp_img, noise_emb=None, privileged_features=None, privileged_weights=None, return_feature=True):
        # sample_prompt = {}
